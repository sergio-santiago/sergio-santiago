...
![9+ Years](./assets/badges/facts/9-years.svg) ![100% Remote](./assets/badges/facts/100-remote.svg) ![CET](./assets/badges/facts/cet.svg)

## 📌 Selected work

| Project | What it shows |
|---|---|
| 📦 [**bulk-import-aws**](https://github.com/sergio-santiago/bulk-import-aws) | Async bulk ingestion on AWS. Go, Lambda, SQS and DynamoDB, with the whole stack in Terraform |
...
| 🤖 [**whatsapp-ai-chatbot**](https://github.com/sergio-santiago/whatsapp-ai-chatbot) | AI put to work inside a product: the WhatsApp Business API bridged to a model, in Node.js |
...
> *The Matrix*
>
> 💡 Understanding the problem usually beats forcing a solution.

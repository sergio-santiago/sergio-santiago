...
| [**daily-race**](https://github.com/sergio-santiago/daily-race) | Standups gamified F1 style. TypeScript, built at a hackathon and running for a real team |
| [**gh-actions-lab**](https://github.com/sergio-santiago/gh-actions-lab) | One small app wired to a complete CI/CD pipeline, with releases and deployments that actually run |

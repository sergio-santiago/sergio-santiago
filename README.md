...
| Architecture & Practices | Languages | Frameworks | Data & Messaging | Cloud, Infra & Observability |
|---|---|---|---|---|
...
| 🎛 [**launchpad-shortcut-deck**](https://github.com/sergio-santiago/launchpad-shortcut-deck) | Hardware and OS kept in sync: MIDI in, real-time LED state out, over a Hammerspoon bridge |
